...
paul = User.create!(nom: "Paul", prenom: "Tremblay", password:123456, email: "paul@tremblay.com")
george = User.create!(nom: "George", prenom: "Germain", password:123456, email: "george@germain.com")
jacque = User.create!(nom: "Jacque", prenom: "Germain", password:123456, email: "jacque@germain.com")
daniel = User.create!(nom: "Daniel", prenom: "Peterson", password:123456, email: "daniel@peterson.com")
robert = User.create!(nom: "Robert", prenom: "Skywalker", password:123456, email: "robert@skywalker.com")
